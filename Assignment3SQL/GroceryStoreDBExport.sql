...
INSERT INTO `Customers` VALUES (1,'Micheal Jordan','Micheal.J@email.com','1325476980'),(2,'Anna Sheppard','Anna.S@email.com','0896754321'),(3,'David Tanner','David.T@email.com','2347895016'),(4,'Freddy Khan','Freddy.K@email.com','3245678901'),(5,'Brenda Penny','Brenda.P@email.com','4567890123'),(6,'Catherine Wilson','Catherine.W@email.com','5768091324'),(7,'Emily Brown','Emily.B@email.com','6789012345'),(8,'Peter Parker','Peter.P@email.com','7890123456');
...
CREATE TABLE `OrderDetails` (
  ...
  CONSTRAINT `orderdetails_chk_2` CHECK ((`Subtotal` >= 0))
...
INSERT INTO `OrderDetails` VALUES (1,1,1,5,11.00),(2,1,4,2,4.00),(3,2,2,10,18.00),(4,2,3,5,15.00),(5,3,5,3,10.50),(6,3,7,2,10.00),(7,4,8,4,4.80),(8,5,6,6,39.00),(9,1,1,5,11.00),(10,1,4,2,4.00),(11,2,2,10,18.00),(12,2,3,5,15.00),(13,3,5,3,10.50),(14,3,7,2,10.00),(15,4,8,4,4.80),(16,5,6,6,39.00);
...
INSERT INTO `Orders` VALUES (1,1,'2024-02-01',15.00),(2,2,'2024-02-02',25.50),(3,3,'2024-02-03',30.75),(4,4,'2024-02-04',10.20),(5,5,'2024-02-05',50.00),(6,6,'2024-02-06',20.30),(7,7,'2024-02-07',12.75),(8,8,'2024-02-08',40.10),(9,1,'2024-02-01',15.00),(10,2,'2024-02-02',25.50),(11,3,'2024-02-03',30.75),(12,4,'2024-02-04',10.20),(13,5,'2024-02-05',50.00),(14,6,'2024-02-06',20.30),(15,7,'2024-02-07',12.75),(16,8,'2024-02-08',40.10);
...
INSERT INTO `Products` VALUES (1,'Banana','Fruits',2.20,200),(2,'Oranges','Fruits',1.80,250),(3,'Milk','Dairy',3.00,90),(4,'Bread','Bakery',2.00,100),(5,'Eggs','Dairy',3.50,70),(6,'Chicken','Meat',6.50,50),(7,'Rice','Grains',5.00,90),(8,'Tomato','Vegetables',1.20,120);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-02-20 01:03:53',NULL),('diagnostics.include_raw','OFF','2025-02-20 01:03:53',NULL),('ps_thread_trx_info.max_length','65535','2025-02-20 01:03:53',NULL),('statement_performance_analyzer.limit','100','2025-02-20 01:03:53',NULL),('statement_performance_analyzer.view',NULL,'2025-02-20 01:03:53',NULL),('statement_truncate_len','64','2025-02-20 01:03:53',NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCustomerOrders`(IN customer_name VARCHAR(255))
BEGIN
...
-- Dump completed on 2025-02-23  1:34:47
CREATE DATABASE  IF NOT EXISTS `GroceryStoreDB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `GroceryStoreDB`;
-- MySQL dump 10.13  Distrib 8.0.31, for macos12 (x86_64)
--
...
--
-- Dumping routines for database 'GroceryStoreDB'
--
/*!50003 DROP PROCEDURE IF EXISTS `GetCustomerOrders` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
